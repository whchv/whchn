<%@ page language="C#" masterpagefile="~/admin/master/Master.master" autoeventwireup="true" inherits="admin_ProductInformationEdit, App_Web_yijgkayn" %>
...
<div class="contentcontainer">
    ...
    <h3>详细图片：</h3>
    <asp:Image ID="imgDetail" runat="server" Visible="False" Width="240" Height="361" />
    ...
    <strong>tips:产品的 详细图片 大小为 240 X 361  (宽/高 单位:像素)</strong>
    <div class="clear"></div>
    ...
    <tr>
        ...
        <td>
            <h3>其它系列产品推荐排序值：</h3>
            <asp:TextBox ID="txtTopSort" runat="server" CssClass="inputbox" MaxLength="5" Width="200"></asp:TextBox>
