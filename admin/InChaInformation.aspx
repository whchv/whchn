<%@ page language="C#" masterpagefile="~/admin/master/Master.master" autoeventwireup="true" inherits="admin_InChaInformation, App_Web_yijgkayn" %>
            ...
            <asp:Repeater ID="RepNewsInfo" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="width: 100px">
                            <a href='InChaInformationEdit.aspx?id=<%# Eval("id") %>' title=""><img src="img/icons/icon_edit.png" alt="Edit"></a>
                            <a href="#" title="" onclick="showInfo(0,'<%# Eval("isshow") %>',4,'<%# Eval("id") %>','我在茶花女信息')"><img src="img/icons/icon_approve.png" alt="Approve"></a> 
                            <a href="#" onclick="showInfo(1,'<%# Eval("isshow") %>',4,'<%# Eval("id") %>','我在茶花女信息')" title=""><img src="img/icons/icon_unapprove.png" alt="Unapprove"></a> 
                            <a href="#" title="" onclick="delInfo(-9,<%# Eval("id") %>,' 我在茶花女信息')"><img src="img/icons/icon_delete.png" alt="Delete"></a>
                        </td>
