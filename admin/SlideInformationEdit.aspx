<%@ page language="C#" masterpagefile="~/admin/master/Master.master" autoeventwireup="true" inherits="admin_SlideInformationEdit, App_Web_yijgkayn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainCP" runat="server">
    <div class="contentcontainer">
        ...
        <h3>是否显示：</h3>
        <asp:CheckBox ID="ckbIsShow" runat="server" Text="显示信息" />
        ...
        <h3>幻灯片标题：</h3>
        <asp:TextBox ID="txtTitle" runat="server" CssClass="inputbox" MaxLength="100" ></asp:TextBox>
        ...
        <h3>排序值：</h3>
        <asp:TextBox ID="txtSort" runat="server" CssClass="inputbox" MaxLength="5" Width="200"></asp:TextBox>
