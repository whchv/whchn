...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        return ((Request.Cookies["normaluser"] != null && Request.Cookies["normaluser"].Values["username"] != null) || Session["user"] != null);
	...
	public override void SetConfig()
	{
        ...
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "vsd", "wav", "wma", "wmv", "xls", "zip" };
