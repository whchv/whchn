<%@ page language="C#" masterpagefile="~/admin/master/Master.master" autoeventwireup="true" inherits="admin_NewsTopInformation, App_Web_yijgkayn" %>
    ...
    <asp:Repeater ID="RepIndexInfo" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td style="width: 200px">
                    <asp:TextBox ID="txtTipsSort" runat="server" CssClass="inputbox" Text='<%# Eval("IndexSort") %>' MaxLength="9" BorderStyle="Groove" Width="50%"></asp:TextBox>
                </td>
                <td style="width: 100px">
                    <%# bool.Parse(Eval("IsIndex").ToString()) ? "<img src='img/icons/icon_approve.png' alt='显示'>" : "  <img src='img/icons/icon_unapprove.png' alt='不显示'>"%>
                    <asp:CheckBox ID="ckbIsTips" Checked='<%# Eval("IsIndex") %>' runat="server" />
                </td>
            </tr>
        </ItemTemplate>
