<%@ page language="C#" masterpagefile="~/admin/master/Master.master" autoeventwireup="true" inherits="admin_EventsInformation, App_Web_yijgkayn" %>
            ...
            <asp:Repeater ID="RepNewsInfo" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="width: 100px">
                            <a href='EventsInformationEdit.aspx?id=<%# Eval("id") %>' title=""><img src="img/icons/icon_edit.png" alt="Edit"></a>
                            <a href="#" title="" onclick="showInfo(0,'<%# Eval("isshow") %>',2,'<%# Eval("id") %>','发展大事记')"><img src="img/icons/icon_approve.png" alt="Approve"></a> 
                            <a href="#" onclick="showInfo(1,'<%# Eval("isshow") %>',2,'<%# Eval("id") %>','发展大事记')" title=""><img src="img/icons/icon_unapprove.png" alt="Unapprove"></a> 
                            <a href="#" title="" onclick="delInfo(-3,<%# Eval("id") %>,' 发展大事记')"><img src="img/icons/icon_delete.png" alt="Delete"></a>
                        </td>
